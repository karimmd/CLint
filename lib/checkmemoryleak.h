...
class CLINTLIB CheckMemoryLeak {
private:
...
class CLINTLIB CheckMemoryLeakInFunction : private Check, public CheckMemoryLeak {
public:
...
class CLINTLIB CheckMemoryLeakInClass : private Check, private CheckMemoryLeak {
public:
...
class CLINTLIB CheckMemoryLeakStructMember : private Check, private CheckMemoryLeak {
public:
...
class CLINTLIB CheckMemoryLeakNoVar : private Check, private CheckMemoryLeak {
public:
